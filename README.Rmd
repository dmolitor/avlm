...
# Anytime-Valid Marginal Effects

Calculate average marginal effects for each covariate in the model:
```{r}
library(marginaleffects)

marginal_effects <- avg_slopes(classic_fit, variables = c("X1", "X2", "X3"))
marginal_effects
```

Convert to anytime-valid marginal effects:
```{r}
av(marginal_effects)
```
